class JogoDaMemoria {
    ...
    async embaralhar() {
        ...
        // vai esperar 3 segundos para atualizar a tela
    ...
    exibirHerois(nomeDoHeroi) {
        /**
         * Procurar os herois pelo nome em nosso heroisIniciais
         * Obtendo somente a imagem dele
         */
        const {img} = this.heroisIniciais.find(({nome}) => nomeDoHeroi === nome)
        // Criar a função na tela, para exbir somente o heroi selecionado.
